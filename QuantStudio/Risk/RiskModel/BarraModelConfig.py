...
ModelArgs = {
    "运行模式": "串行",
    "子进程数": 8, # cpu_count() - 1,
    "所有因子": ["DailyReturn", "TotalCap", "ESTU", "Industry", "Size", "Beta", "Momentum", "ResidualVolatility", "NonlinearSize", "BookToPrice", "Liquidity", "EarningsYield", "Growth","Leverage"],
    "收益率因子": "DailyReturn",
    "ESTU因子": "ESTU",
    "行业因子": "Industry",
    "所有行业": [
        "Energy","Chemicals","Construction Materials","Diversified Metals","Materials",
    ...
    "风格因子": ['Size', 'Beta', 'Momentum', 'ResidualVolatility', 'NonlinearSize', 'BookToPrice', 'Liquidity', 'EarningsYield', 'Growth', 'Leverage'],
    "市值因子": "TotalCap",
...
FactorVolatilityRegimeAdjustmentArgs = {
    "样本长度": -1,
    "半衰期": 90,
    "预测期数": -1
}

BayesianShrinkageArgs = {
    "分组数": 10,
    "q": 0.1
}

SpecificVolatilityRegimeAdjustmentArgs = {
    "样本长度": -1,
    "半衰期": 90,
    "预测期数": -1
}