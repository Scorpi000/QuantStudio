...
class _FactorTable(FactorTable):
        ...
        with self._FactorDB._getLock(self._QSArgs.Name) as DataLock:
            ...
            for iFactorName in factor_names:
                if iFactorName in AllFactorNames:
                    with self._FactorDB._openHDF5File(self._FactorDB._QSArgs.MainDir / self._QSArgs.Name / (iFactorName + "." + self._Suffix), mode="r") as File:
                        if key is None:
    ...
    def readFactorData(self, ifactor_name, ids, dts):
        ...
        if LookBack == 0: return self._readFactorData(ifactor_name, ids, dts)
