...
# 滚动窗口
@FactorOperatorized(operator_type="Time", sys_args={"名称": "rolling_sum", "入参数": 1, "运算时点": "单时点", "运算ID": "多ID"})
...
# 扩张窗口
@FactorOperatorized(operator_type="Time", sys_args={"名称": "expanding_sum", "入参数": 2, "运算时点": "单时点", "运算ID": "多ID"})
...
if __name__=="__main__":
    ...
    print(CumVol.Name, CumVol.readData(ids=IDs, dts=DTs, dt_ruler=DTRuler), sep="\n")
