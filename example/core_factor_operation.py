...
def test_point(f, idt, iid, x, args):
    return x[0] + x[1]
test_point = makeFactorOperator(test_point, operator_type="Point", args={"Arity": 2, "DTMode": "多时点", "IDMode": "多ID"})
...
if __name__ == "__main__":
    ExecEngine = Engine()
    Cache = HDF5Cache(args={"DTRuler": DTRuler, "MinDTUnit": dt.timedelta(1), "CacheDir": r"C:\Users\hst\Desktop\Cache", "PIDs": ["0"], "ClearStart": True})
    Cache.start()
